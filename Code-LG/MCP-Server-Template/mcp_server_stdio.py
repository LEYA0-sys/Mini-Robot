# mcp_server_stdio.py - MCP 服务器开发模板 (STDIO 版本)
# ================================================
# 
# 这是一个使用 STDIO 传输的 MCP (Model Context Protocol) 服务器开发模板
# 使用 FastMCP 框架实现，支持标准输入输出传输协议
# 
# 本模板特性：
# 1. 完整的 MCP 功能支持（工具、提示、资源）
# 2. 基于 FastMCP 的简洁装饰器实现
# 3. 详细的开发指导注释
# 4. 生产环境就绪的代码结构
# 5. STDIO 传输协议支持
#
...
logger = logging.getLogger('MCPServerSTDIO')
...
# 服务器基本信息配置
# 开发者：修改这些配置以匹配你的项目
SERVER_NAME = "mcp-server-template-stdio"
SERVER_VERSION = "1.0.0"
SERVER_DESCRIPTION = "A comprehensive MCP server template with STDIO transport"
...
if __name__ == "__main__":
    ...
    4. 运行服务器：python mcp_server_stdio.py
    5. 在客户端中通过 STDIO 连接到这个服务器
